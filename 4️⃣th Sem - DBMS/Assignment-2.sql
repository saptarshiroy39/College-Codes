...
ALTER TABLE Member_1431 ADD CONSTRAINT Member_Id_pk PRIMARY KEY (Member_Id);
...
ALTER TABLE Books_1431 ADD CONSTRAINT Book_No_pk PRIMARY KEY (Book_No);
...
ALTER TABLE Issue_1431 ADD CONSTRAINT Lib_Issue_Id_pk PRIMARY KEY (Lib_Issue_Id);
